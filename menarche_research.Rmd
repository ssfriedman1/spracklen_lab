...
```{r}
table1(~ AGE + MENARCHE + ETHNICITY + RACE + BMI+ t0.normindx + SMOKING + ALCOHOL| PREECLMP, data = merged, overall= F, extra.col=list('P-value'=pvalue), render.continuous = my.render.cont, render.categorical = my.render.cat)

table1(~ AGE + MENARCHE + ETHNICITY + RACE + BMI + t0.normindx + SMOKING + ALCOHOL| HYPTPREG, data = merged,render.continuous = my.render.cont, render.categorical = my.render.cat, overall= F, extra.col=list('P-value'=pvalue))

table1(~ AGE + MENARCHE + ETHNICITY + RACE + BMI + t0.normindx + SMOKING + ALCOHOL| BABYLT5LBS, data = merged,render.continuous = my.render.cont, render.categorical = my.render.cat, overall= F, extra.col=list('P-value'=pvalue))

table1(~ AGE + MENARCHE + ETHNICITY + RACE + BMI + t0.normindx + SMOKING + ALCOHOL| BABYGT9LBS, data = merged,render.continuous = my.render.cont, render.categorical = my.render.cat, overall= F, extra.col=list('P-value'=pvalue))

table1(~ AGE + MENARCHE + ETHNICITY + RACE + BMI + t0.normindx + SMOKING + ALCOHOL| DIABPREG, data = merged,render.continuous = my.render.cont, render.categorical = my.render.cat, overall= F, extra.col=list('P-value'=pvalue))

table1(~ AGE + MENARCHE + ETHNICITY + RACE + BMI + t0.normindx + SMOKING + ALCOHOL| PRETERM, data = merged,render.continuous = my.render.cont, render.categorical = my.render.cat, overall= F, extra.col=list('P-value'=pvalue))
```